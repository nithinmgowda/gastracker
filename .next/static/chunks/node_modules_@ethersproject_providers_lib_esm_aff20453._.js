...
class Resolver {
    ...
    _getAddress(coinType, hexBytes) {
        ...
        if (coinInfo == null) {
            logger.throwError("unsupported coin type: ".concat(coinType), __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$ethersproject$2f$logger$2f$lib$2e$esm$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Logger"].errors.UNSUPPORTED_OPERATION, {
        ...
        return __awaiter(this, void 0, void 0, function*() {
            ...
            for(let i = 0; i < urls.length; i++){
                ...
                if (result.status >= 400 && result.status < 500) {
                    return logger.throwError("response not found during CCIP fetch: ".concat(errorMessage), __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$ethersproject$2f$logger$2f$lib$2e$esm$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Logger"].errors.SERVER_ERROR, {
                        url,
                        errorMessage
                    });
                }
            ...
            return logger.throwError("error encountered during CCIP fetch: ".concat(errorMessages.map((m)=>JSON.stringify(m)).join(", ")), __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$ethersproject$2f$logger$2f$lib$2e$esm$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Logger"].errors.SERVER_ERROR, {
                urls,
                errorMessages
            });
        });
