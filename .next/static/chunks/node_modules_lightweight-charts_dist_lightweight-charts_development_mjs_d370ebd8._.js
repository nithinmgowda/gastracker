...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$fancy$2d$canvas$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$module__evaluation$3e$__ = __turbopack_context__.i("[project]/node_modules/fancy-canvas/index.mjs [app-client] (ecmascript) <module evaluation>");
            ...
            case 'custom':
                {
                    ...
                    var _this__private__options_priceFormat_tickmarksFormatter;
                    this._private__formatter = {
                        format: formatter,
                        formatTickmarks: (_this__private__options_priceFormat_tickmarksFormatter = this._private__options.priceFormat.tickmarksFormatter) !== null && _this__private__options_priceFormat_tickmarksFormatter !== void 0 ? _this__private__options_priceFormat_tickmarksFormatter : (prices)=>prices.map(formatter)
                    };
                    break;
                }
            case 'volume':
...
class PriceScale {
    ...
    _private__formatTickmarks(prices, fallbackFormatter) {
        ...
        var _this__private__localizationOptions_tickmarksPriceFormatter;
        return this._private__formatValues(prices, (_this__private__localizationOptions_tickmarksPriceFormatter = this._private__localizationOptions.tickmarksPriceFormatter) !== null && _this__private__localizationOptions_tickmarksPriceFormatter !== void 0 ? _this__private__localizationOptions_tickmarksPriceFormatter : priceFormatter ? (values)=>values.map(priceFormatter) : undefined, fallbackFormatter);
    }
    ...
    _private__formatPercentageTickmarks(percentages, fallbackFormatter) {
        ...
        var _this__private__localizationOptions_tickmarksPercentageFormatter;
        return this._private__formatValues(percentages, (_this__private__localizationOptions_tickmarksPercentageFormatter = this._private__localizationOptions.tickmarksPercentageFormatter) !== null && _this__private__localizationOptions_tickmarksPercentageFormatter !== void 0 ? _this__private__localizationOptions_tickmarksPercentageFormatter : tickmarksPercentageFormatter ? (values)=>values.map(tickmarksPercentageFormatter) : undefined, fallbackFormatter);
    }
...
class ChartModel {
    ...
    _private__addPane(index) {
        ...
        const idx = index !== null && index !== void 0 ? index : this._private__panes.length - 1;
...
class ChartApi {
    ...
    addPane() {
        let preserveEmptyPane = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : false;
...
//# sourceMappingURL=node_modules_lightweight-charts_dist_lightweight-charts_development_mjs_d370ebd8._.js.map